...
export const EN_PLAIN: Record<string, string> = {
  ...
  "中国官方": "China official",
  "主页": "Homepage",
  "主题、命令包装器和启动参数": "Theme, command wrapper and launch arguments",
  ...
  "当前": "Current",
  "当前 CODEX_HOME 未发现可用的完整插件市场，API Key 模式下可能出现插件安装后不可用。":
    "No complete plugin marketplace was found under the current CODEX_HOME; in API Key mode plugins may be unavailable after install.",
  ...
  "插件市场需要修复": "Plugin marketplace needs repair",
  ...
  "本地会话": "Local sessions",
  "本地插件市场": "Local plugin marketplace",
  "本地整体": "Local overall",
  "本地脚本": "Local scripts",
  "权重": "Weight",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "卸载入口": "Uninstall entrypoints",
  "修复快捷方式": "Repair shortcuts",
  "后端已修复，命令包装器当前未启用。": "Backend repaired; command wrapper is not enabled.",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/^后端已修复，命令包装器已指向 (.+)。$/, "Backend repaired; command wrapper points to $1."],
  [/^后端修复部分失败：(.+)$/, "Backend repair partially failed: $1"],
