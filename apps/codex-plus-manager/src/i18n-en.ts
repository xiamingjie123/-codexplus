...
export const EN_PLAIN: Record<string, string> = {
  ...
  "下一页": "Next page",
  "末页": "Last page",
  "运行状态概览": "Runtime status overview",
  "运行概览": "Runtime overview",
  "版本、应用、入口和最近启动状态": "Version, app, entrypoints, and recent launch status",
  "需要关注": "Needs attention",
  "当前没有阻塞项": "No current blockers",
  "Codex Deck 已准备就绪": "Codex Deck is ready",
  "建议先处理异常状态再启动 Codex": "Resolve abnormal states before launching Codex",
  "日志与诊断": "Logs and diagnostics",
  "市场、模型与服务档位": "Marketplace, models, and service tiers",
  "会话、导出和输入体验": "Conversations, exports, and input experience",
  "后续建议与发送方式": "Follow-up suggestions and send behavior",
  "语言、菜单和启动速度": "Language, menus, and startup speed",
  "Zed 与 worktree 能力": "Zed and worktree capabilities",
  "增强功能分类": "Enhancement categories",
  "在非完整增强场景中继续准备 Browser、Chrome 与 Computer Use 的本地守护状态。":
    "Continue preparing local Browser, Chrome, and Computer Use guards outside full enhancement mode.",
  ...
  "项目来源筛选": "Project source filter",
  "全部": "All",
  "搜索远程项目": "Search remote projects",
  "搜索项目、主机或路径...": "Search projects, hosts, or paths...",
  "远程项目列表": "Remote project list",
  "项目": "Project",
  "来源": "Source",
  "未打开": "Never opened",
  "打开": "Open",
  "没有匹配的远程项目": "No matching remote projects",
  "调整搜索词或项目来源筛选。": "Adjust the search term or project source filter.",
  "脚本视图": "Script views",
  "搜索脚本": "Search scripts",
  "搜索名称、作者或标签...": "Search names, authors, or tags...",
  "市场脚本筛选": "Marketplace script filter",
  "本地脚本筛选": "Local script filter",
  "内置、手动和市场安装脚本": "Built-in, manual, and marketplace-installed scripts",
  "没有匹配的市场脚本": "No matching marketplace scripts",
  "调整搜索词或筛选条件。": "Adjust the search term or filters.",
  "运行状态": "Runtime status",
  "没有匹配的本地脚本": "No matching local scripts",
  "本地脚本整体已关闭": "Local scripts globally disabled",
  "本地脚本整体已启用": "Local scripts globally enabled",
  "刷新全部": "Refresh all",
  "应用、入口和接管状态": "App, entrypoint, and takeover status",
  "安装、修复与卸载": "Install, repair, and uninstall",
  "Watcher 生命周期": "Watcher lifecycle",
  "识别和保存应用位置": "Detect and save the app location",
  "路径覆盖与调试端口": "Path override and debug ports",
  ...
  "图片理解与降级处理": "Image understanding and fallback handling",
  "建议生成服务配置": "Suggestion service configuration",
  "背景外观": "Background appearance",
  "覆盖图片与透明度": "Overlay image and opacity",
  "启动参数": "Launch arguments",
  "Codex App 额外参数": "Extra Codex App arguments",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "{0} ms": "{0} ms",
  "发现 {0} 个需要处理的状态": "Found {0} state(s) requiring attention",
  "{0} 个状态等待处理": "{0} state(s) waiting for action",
  "{0} 个 Codex Deck 可识别项目": "{0} project(s) recognized by Codex Deck",
  "显示 {0} / {1} 个项目": "Showing {0} / {1} project(s)",
  "默认策略：{0}": "Default strategy: {0}",
  "{0} 个，可更新 {1} 个": "{0} script(s), {1} update(s)",
  "{0} 个，已启用 {1} 个": "{0} script(s), {1} enabled",
  "显示 {0} / {1}": "Showing {0} / {1}",
  "已安装 {0} 个市场脚本": "{0} marketplace script(s) installed",
  ...
  "供应商 {0}": "Provider {0}",
  "全部 ({0})": "All ({0})",
  "API 供应商 ({0})": "API providers ({0})",
  "聚合供应商 ({0})": "Aggregate providers ({0})",
  "{0} 个会话": "{0} session(s)",
